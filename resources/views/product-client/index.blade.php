                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addNewRecordLabel">Add Product Price</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <form id="productClientForm">
                                @csrf
                                <input type="hidden" id="txtClientId" name="client_id" value="{{$user->id}}">
                                <div class="row">
                                    <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h3 class="mb-0 font-size-18">Products Client </h4>
                    </div>
...
<script>
    var table = $('.display').DataTable({
        ...
        ajax: "{{ route('product-client.index') }}",
        columns: [{
    ...
    $('#btnClientPrice').click(function () {
            $.ajax({
                ...
                if(response.message == 'success'){
                        ...
                        clearFields();
                        $('#addNewRecord').find('#ajax-alert-danger').addClass('alert-danger').show(function() {
