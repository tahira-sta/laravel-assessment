    ...
    return function (e) {
        ...
        return n.m = e, n.c = t, n.d = function (e, t, l) {
            ...
            if (n.r(l), Object.defineProperty(l, "default", {
                ...
                for (var o in e) n.d(l, o, function (t) {
                    return e[t]
                }.bind(null, o));
            return l
        }, n.n = function (e) {
        ...
        var s = (l = {
                ...
                getStyle: function (e, t) {
                    var n, l = e.style[t] || e.currentStyle && e.currentStyle[t];
        ...
        e.exports = {
            ...
            pick2: function (e, t) {
                ...
                return {
                    ...
                    then: function (e) {
                        var t;
                        if (n) return t = o.call(arguments, 1), l.isString(e) ? (l.pick(n, e) || function () {}).apply(n, t) : e.call(n, n)
                    }
                }
            },
            mixin: function (e, t) {
            ...
            getScheduleChanges: function (e, t, n) {
                ...
                return l.forEach(t, (function (t) {
                    i.indexOf(t) > -1 ? r.compare(e[t], n[t]) && (o[t] = n[t]) : l.isUndefined(n[t]) || e[t] === n[t] || (o[t] = n[t])
                })), l.isEmpty(o) ? null : o
            }
        }
    }, function (e, t, n) {
        ...
        var l = n(0),
            ...
            a = {
                ...
                _on: function (e, t, n, o) {
                    var i, r, s;
                    i = t + l.stamp(n) + (o ? "_" + l.stamp(o) : ""), e._evt && e._evt[i] || (s = r = function (t) {
                    ...
                    }, e.addEventListener("mouseenter" === t ? "mouseover" : "mouseout", r, !1)) : ("mousewheel" === t && e.addEventListener("DOMMouseScroll", r, !1), e.addEventListener(t, r, !1)) : "attachEvent" in e && e.attachEvent("on" + t, r), e._evt = e._evt || {}, e._evt[i] = r)
                },
                ...
                trigger: function (e, t, n) {
                    l.isUndefined(n) && /(mouse|click)/.exec(t) && (n = a.mouseEvent(t)), e.dispatchEvent ? e.dispatchEvent(n) : e.fireEvent && e.fireEvent("on" + t, n)
                },
                mouseEvent: function (e, t) {
                    ...
                    }, t), o.msie && o.version < 9 && delete i.wheelDelta, "function" == typeof document.createEvent ? (n = document.createEvent("MouseEvents")).initMouseEvent(e, i.bubbles, i.cancelable, i.view, i.detail, i.screenX, i.screenY, i.clientX, i.clientY, i.ctrlKey, i.altKey, i.shiftKey, i.metaKey, i.button, document.body.parentNode) : document.createEventObject && (n = document.createEventObject(), l.forEach(i, (function (e, t) {
                        n[t] = e
                    }), this), n.button = {
                        0: 1,
                        1: 4,
        ...
        c.and = function (e) {
            ...
            return e = s.call(arguments), t = e.length,
                function (n) {
                    for (var l = 1, o = e[0].call(null, n); l < t; l += 1) o = o || e[l].call(null, n);
                    return o
                }
        }, c.merge = function (e) {
            ...
            return i(t, (function (e) {
                a(n, e.items)
            })), o.items = n, o.length = l.keys(o.items).length, o
            ...
            u = {
                ...
                _retriveScheduleDataFromDate: function (e, t) {
                    var n, o, i, a = e.children.single(),
                        u = 0;
                    return !!a && (i = a.getRenderDateRange(), n = i.length, o = a.getRenderDateGrids(), l.forEach(i, (function (e, n) {
                        r.isSameDate(e, t) && (u = n)
                    })), function (t) {
                        var a = 0;
                        return l.forEach(i, (function (e, n) {
            ...
            c = {
                ...
                _retriveScheduleDataFromDate: function (e) {
                    ...
                    return l.bind((function (n, o, a) {
                        var r, c, d, h, p, m;
                        return r = n.getHours() - a + u(n.getMinutes()), c = new s(t).addMinutes(i.minutesFromHours(r)), d = r, h = new s(t).addMinutes(i.minutesFromHours(d)), p = o.getHours() - a + u(o.getMinutes()), m = new s(t).addMinutes(i.minutesFromHours(p)), l.extend({
                            target: e,
                            relatedView: e,
                            gridY: r,
                            timeY: c,
        ...
        i.inherit(u, l), u.prototype._onMouseDown = function (e) {
            ...
            var i, a, r;
            return (a = (i = ((e = e < 0 ? 0 : e) + t) / 2) - n / 2) < l ? (a = 0, r = i - l - 8) : a + n > o ? r = i - (a = o - n - l) - l - 8 : a -= l, (r < 0 || r > n) && (r = null), {
                y: a,
                arrowTop: r
            }
        ...
        function m(e, t) {
            ...
            this.options = l.extend({
                ...
                return l.stamp(e) - l.stamp(t)
            })), this.days = t.children.single().getRenderDateRange().length, this.ratio = l.bind((function (e) {
                return i.ratio(n.days, 100, e)
            })), this.startCoord = [0, 0], this.guideElements = {}, this.grids = t.grids
        }
        m.prototype.destroy = function () {
            this.clear(), this.options = this.view = this.weeks = this.days = this.ratio = this.startCoord = this.guideElements = null
            ...
            for (var t = this.weeks, n = l.pick(this.view, "options", "workweek") ? this.days + 2 : this.days, o = function (e, t) {
                    return p(r.millisecondsTo("day", h(t - e)))
                }, i = r.start(t[0].options.renderStartDate), a = e < i, c = new s(i), u = new s(i).addDate(a ? -n : n).addDate(-1), d = o(e, c), m = 0; !r.isBetweenWithDate(e, c, u);) c.addDate(a ? -n : n), u = new s(c).addDate(n - 1), d = o(e, c), m += a ? -1 : 1;
            return [d, m]
            ...
            n.isCreationMode ? i && !r.isSameMonth(u, i.start) && (i.start.setMonth(u.getMonth()), i.start.setDate(1), i.end.setMonth(u.getMonth()), i.end.setDate(1)) : (a = (t = this._getCoordByDate(i.getStarts()))[0], c = t[1], l.extend(this.options, {
                top: parseInt(o.style.top, 10) + "px",
                height: parseInt(o.style.height, 10) + "px",
                label: i.title
            }, i)), (l.isUndefined(a) || l.isUndefined(c)) && (a = (t = this._getCoordByDate(i.getStarts()))[0], c = t[1]), this.startCoord = [a, c], this.update(a, c)
            ...
            u = {
                ...
                getMatrices: function (e, t) {
                    ...
                    return o(t, (function (t) {
                        ...
                        o(t, (function (t) {
                            for (var n, o, r = e.items[t], s = 0, c = !1; !c;) !1 === (o = i(a, s)) ? (a[0].push(r), c = !0) : r.collidesWith(a[o][s]) || (n = o + 1, l.isUndefined(a[n]) && (a[n] = []), a[n][s] = r, c = !0), s += 1
                        })), n.push(a)
                    })), n
                },
        ...
        e.exports = function (e, t, n, y, S) {
            ...
            return l.forEach(R, (function (e) {
                ...
                }))) : "timegrid" === t.type && (o = new p(i, y, w.getPanelByName(i).container), _.addChild(o), l.forEach(a, (function (t) {
                    y.isReadOnly && "click" !== t || (_.handler[t][i] = new b[t](n, o, e, y))
            ...
            })), y.useCreationPopup && (P = new m(t, e.calendars, y.usageStatistics), I = function (e) {
                l.extend(e, {
                    useCreationPopup: !0
                }), e.isAllDay ? _.handler.creation.allday.fire("beforeCreateSchedule", e) : _.handler.creation.time.fire("beforeCreateSchedule", e)
            }, P.on("beforeCreateSchedule", I)), D = function (e) {
                P && P.setCalendars(e)
            }, e.on("setCalendars", D), y.useDetailPopup && (x = new f(t, e.calendars), X = function (t) {
            ...
            })), y.useCreationPopup ? (O = function (t) {
                var n = e.calendars;
                ...
                })), y.useCreationPopup && (P.off("beforeCreateSchedule", I), P.destroy()), y.useDetailPopup && (x.off("beforeDeleteSchedule", M), x.destroy()), _.off()
            }, {
                view: _,
                refresh: function () {
        ...
        function _(e, t, n) {
            ...
            n.style.position = "relative", e = e || "time", d.call(this, i), l.browser.safari || (this._autoScroll = new p(i)), this.stickyContainer = r, this.options = l.extend({
                viewName: e,
                renderStartDate: "",
                renderEndDate: "",
                hourStart: 0,
            ...
            }]), this.intervalID = 0, this.timerID = 0, this._scrolled = !1, this._cacheParentViewModel = null, this._cacheHoursLabels = null, this.attachEvent()
        }
        l.inherit(_, d), _.prototype.viewName = "timegrid", _.prototype._beforeDestroy = function () {
            clearInterval(this.intervalID), clearTimeout(this.timerID), this._autoScroll && this._autoScroll.destroy(), r.off(this.stickyContainer, "click", this._onClickStickyContainer, this), this._autoScroll = this.hourmarkers = this.intervalID = this.timerID = this._cacheParentViewModel = this.stickyContainer = null
            ...
            clearInterval(this.intervalID), clearTimeout(this.timerID), this.intervalID = this.timerID = null, this.timerID = setTimeout(l.bind(this.onTick, this), 1e3 * (60 - (new y).getSeconds())), r.on(this.stickyContainer, "click", this._onClickStickyContainer, this)
        }, _.prototype.scrollToNow = function () {
            var e, t, n, l, o, i = this.container;
            this.hourmarkers && this.hourmarkers.length && (e = this.hourmarkers[0].offsetTop, t = this.getViewBound(), n = e, l = t.height / 4, 10, o = function () {
        ...
        l.inherit(d, r), d.prototype._parseDateGroup = function (e) {
            ...
            var n, l, o, a, r = t.baseMS,
                ...
                f = s * m / r,
                g = e.duration();
            return n = s * ((g = g > u ? g : u) + h + p) / r, l = s * h / r, o = s * g / r, a = s * p / r, m < 0 && (f = 0, n += s * m / r, c = !0), n + f > s && (n = s - f, d = !0), {
                top: f,
        ...
        e.exports = (l.default || l).template({
            ...
            29: function (e, t, n, l, o) {
                ...
                }) : a) + 'time-resize-handle handle-x" style="margin-left: ' + r(e.lambda((i = (i = o && s(o, "root")) && s(i, "styles")) && s(i, "paddingLeft"), t)) + ';">&nbsp;</div>'
            },
            compiler: [8, ">= 4.3.0"],
            main: function (e, t, n, l, o) {
                var i, a, r = null != t ? t : e.nullContext || {},
        ...
        (function (t) {
            ...
            r.DIRECTION = {
                ...
                var t, n, l = i.getComputedStyle(e);
        ...
        e.exports = (l.default || l).template({
            1: function (e, t, n, l, o) {
                ...
                }) : a) + 'timegrid-timezone" data-timezone-index="' + u(typeof (a = null != (a = d(n, "index") || o && d(o, "index")) ? a : s) === c ? a.call(r, {
                    name: "index",
                    hash: {},
                    data: o,
                    loc: {
                ...
                }) : a) + "%; border-right: " + u(e.lambda((i = (i = o && d(o, "root")) && d(i, "styles")) && d(i, "leftBorderRight"), t)) + "; background-color: " + u(typeof (a = null != (a = d(n, "backgroundColor") || (null != t ? d(t, "backgroundColor") : t)) ? a : s) === c ? a.call(r, {
                    name: "backgroundColor",
                    hash: {},
                    data: o,
                    loc: {
            ...
            5: function (e, t, n, l, o) {
                ...
                }) : a) + 'timegrid-hour" style="height: ' + c(e.lambda((i = (i = o && u(o, "root")) && u(i, "styles")) && u(i, "oneHourHeight"), t)) + "; color: " + c("function" == typeof (a = null != (a = u(n, "color") || (null != t ? u(t, "color") : t)) ? a : s) ? a.call(r, {
                    name: "color",
                    hash: {},
                    data: o,
                    loc: {
            ...
            8: function (e, t, n, l, o) {
                ...
                }) : a) + 'timegrid-hourmarker" style="top:' + c(u((i = o && d(o, "root")) && d(i, "hourmarkerTop"), t)) + "%; margin-top: calc(6px - " + c(u((i = (i = o && d(o, "root")) && d(i, "styles")) && d(i, "halfHourHeight"), t)) + "); height: " + c(u((i = (i = o && d(o, "root")) && d(i, "styles")) && d(i, "halfHourHeight"), t)) + ';">\n                    <div class="' + c("function" == typeof (a = null != (a = d(n, "CSS_PREFIX") || (null != t ? d(t, "CSS_PREFIX") : t)) ? a : s) ? a.call(r, {
                    name: "CSS_PREFIX",
                    hash: {},
                    data: o,
                    loc: {
            ...
            13: function (e, t, n, l, o) {
                ...
                }) : a) + 'timegrid-hourmarker-time" style="color: ' + c(u((i = (i = o && d(o, "root")) && d(i, "styles")) && d(i, "currentTimeColor"), t)) + "; font-size: " + c(u((i = (i = o && d(o, "root")) && d(i, "styles")) && d(i, "currentTimeFontSize"), t)) + ';">' + (null != (i = (d(n, "timegridCurrentTime-tmpl") || t && d(t, "timegridCurrentTime-tmpl") || s).call(r, t, {
                    name: "timegridCurrentTime-tmpl",
                    hash: {},
                    data: o,
                    loc: {
            ...
            15: function (e, t, n, l, o) {
                ...
                }) : a) + 'timegrid-gridline-half" style="height: ' + c(u((i = (i = o && d(o, "root")) && d(i, "styles")) && d(i, "halfHourHeight"), t)) + "; border-bottom: " + c(u((i = (i = o && d(o, "root")) && d(i, "styles")) && d(i, "halfHourBorderBottom"), t)) + ';"></div>\n        </div>\n'
            },
        ...
        d.prototype.destroy = function () {
            ...
            var t, n = a.closest(e, o.classname(".time-date"));
        ...
        e.exports = function (e, t, n, S) {
            ...
            return _ = r.appendHTMLElement("div", t, o.classname("month")), C = new c(S, _, e.Month), v = new m(S.month, t, e.theme), w = new u(n, C, e), S.isReadOnly || (P = new d(n, C, e, S), k = new h(n, C, e), b = new p(n, C, e)), R = function () {
                v && v.hide()
            }, I = function () {
                v && v.refresh()
            ...
            })), S.useCreationPopup && (E = new f(t, e.calendars, S.usageStatistics), D = function (e) {
                P.fire("beforeCreateSchedule", l.extend(e, {
                    useCreationPopup: !0
                }))
            }, E.on("beforeCreateSchedule", D)), S.useDetailPopup && (x = new g(t, e.calendars), X = function (t) {
                var n = t.schedule.calendarId;
            ...
            }, E.on("beforeUpdateSchedule", O), x.on("beforeUpdateSchedule", F)) : x.on("beforeUpdateSchedule", O)), e.on("clearSchedules", R), e.on("updateSchedule", I), b && b.on("monthMoveStart_from_morelayer", (function () {
                v.hide()
            })), C.handler = {
                click: {
                    default: w
                ...
                v.destroy(), e.off("clearSchedules", R), e.off("updateSchedule", I), l.forEach(C.handler, (function (e) {
                    l.forEach(e, (function (e) {
                        e.off(), e.destroy()
                    }))
                })), S.useCreationPopup && S.useDetailPopup && E.off("beforeUpdateSchedule", I), S.useCreationPopup && (P && P.off("beforeCreateSchedule", void 0), E.off("saveSchedule", D), E.destroy()), S.useDetailPopup && (w.off("clickSchedule", X), x.off("beforeUpdateSchedule", I), x.off("beforeDeleteSchedule", M), x.destroy())
